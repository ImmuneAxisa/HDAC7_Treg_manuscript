...
Analyses related to the knock-down of HDAC7 in human Treg cells presented in supplementary figures. We run differential expression analyses with DESeq2 and then run GSEA on hallmarks genesets, and geneset from the HDAC7 R150H KI mouse Treg infiltrating the brain during EAE.
