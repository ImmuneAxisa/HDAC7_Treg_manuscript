...
saveRDS(reductions.meta, file.path(results_dir,"master_seurat_low_res_clustering_table_harmony.rds"))


saveRDS(merged.seurat, file.path(objects_dir,"master_seurat_harmony_low_res_clustered.rds"))
