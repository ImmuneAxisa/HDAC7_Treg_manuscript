...
meta_table <- readRDS(file.path(results_dir,"master_seurat_low_res_clustering_table_harmony.rds"))
...
ggsave(file.path(results_dir,"low_res_clustering_plots_harmony.pdf"), 
